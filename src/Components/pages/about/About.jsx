...
import Footer from '../User/User_home/Footer';
import Navbar from '../User/User_home/Navbar';
import './about.css';
...
const AboutUs = () => {
  return (
    <>
      <Navbar />
      <div className="container mx-auto px-4 py-8" style={{ marginTop: '18rem' }}>
        <h1 className="aboutUsHeading">About Us</h1>
        <p className="text-lg mb-8">
          Welcome to <span style={{color:'red',backgroundColor:'black'}}>Stay here</span>, where we are
        ...
        <h2 className="aboutUsHeading">Our Vision</h2>
        <p className="text-lg mb-8">
          At <span style={{color:'red',backgroundColor:'black'}}>Stay here</span>, we envision a world
          where every traveler finds the perfect accommodation that suits their
          needs and preferences. We aim to simplify the hotel room booking process,
        ...
        <p className="text-lg">
          Thank you for choosing <span style={{color:'red',backgroundColor:'black'}}>Stay here</span>.
